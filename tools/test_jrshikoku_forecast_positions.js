...
assert.strictEqual(yosan.trains[0].pos, "JSYF293");
...
assert.strictEqual(kitaiyo.trains[0].pos, "JSYF35");
...
assert.strictEqual(kitaiyoIyonada.trains[0].pos, "JSYF34");
...
assert.strictEqual(kitauwajimaIyonada.trains[0].pos, "JSYF185");
...
assert.strictEqual(forecastDefinitions.get("34").hostStationCode, "U02");
...
assert.strictEqual(iyonadaDefinitions.find(function(row) { return row.positionNumber === "34"; }).hostStationCode, "U02");
assert.strictEqual(iyonadaDefinitions.find(function(row) { return row.positionNumber === "185"; }).hostStationCode, "U27");
